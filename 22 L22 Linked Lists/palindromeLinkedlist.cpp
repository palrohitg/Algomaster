/*
	...
	Follow up :
	1. Could you solve this O(N) and O(1)
	a. Reverse the first half while finding the middle
	b. Compare the reverse first half with the second half

	Note : but this will break the structure of the linked lists
