/*
	Height balance tree :
	1. the left and subtree and right subtree height is balance by must differ by one
...
/*
	Property of the balance tree
	1. The differ of subtress not greater than one
	2. the left subtree and the right subtree is balanced
	bottom up recursion using each node O(n)
*/
