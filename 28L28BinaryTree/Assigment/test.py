# This is the first level of the assigment assigment sources for the questions
# Firstly we had the values to increase the budget of the values 
# Readme files to print out hte
...
class Employee():
    ...
    def __init__(self, max_profit=54000):
        ...
        print(self.rating_ratio_map)
        print(self.emp_details_with_salary_ratio)
        print(self.total_rating_salary_emp)
        ...
        try:
            if self.emp_details_with_salary_ratio:
                for each_emp in self.emp_details_with_salary_ratio:
                    bonus_give = (each_emp.get("salary_with_rating") * self.max_profit) // self.total_rating_salary_emp
